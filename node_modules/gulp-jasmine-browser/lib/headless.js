...
function createServer(options) {
  ...
  var opts = (0, _objectWithoutProperties3.default)(options, ['driver']);

  var query = qs.stringify({ catch: opts.catch, random: opts.random, throwFailures: opts.throwFailures });
